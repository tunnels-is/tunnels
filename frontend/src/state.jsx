...
export var STATE = {
  ...
  Theme: {
    borderColor: " border border-[#e7e3d7] cursor-pointer rounded-md",
    menuBG: " bg-[#ffffff]",
    mainBG: " bg-[#fdfcf8]",
    neutralBtn:  "btn btn-primary",
    successBtn:  "btn btn-success",
    warningBtn:  "btn btn-primary",
    errorBtn:    "btn btn-danger",
    activeSelect:  "btn btn-primary",
    neutralSelect: "btn btn-outline",
    tabs: "data-[state=active]:text-[#0a0a0a]",
    greenIcon: "btn-icon btn-icon-success",
    redIcon:   "btn-icon btn-icon-danger",
    badgeNeutral: "tag tag-neutral",
    badgeSuccess: "tag tag-success",
    badgeWarning: "tag tag-warning",
    badgeError:   "tag tag-danger",
    toast: " !text-[#0a0a0a] bg-[#ffffff] border-[#e7e3d7]"
  },
