...
const Connections = () => {
  ...
  const renderConnection = (c) => {
    ...
    return (
      <div className={`connection-card`} key={c.WindowsGUID}>
        ...
        <div className="button-and-text-seperator"></div>
        <KeyValue
          value={String(c.EnableDefaultRoute)}
          label={"Default Route"}
        />
        <KeyValue
          value={STORE.EncryptionTypes[c.EncryptionType]}
        ...
        <KeyValue
          value={String(
            c.DNSServers && c.DNSServers.length > 0
              ? c.DNSServers[0]
              : "Default",
          )}
          label={"Primary DNS"}
        ...
        <KeyValue
          value={String(
            c.DNSServers && c.DNSServers.length > 1 ? c.DNSServers[1] : "",
          )}
          label={"Secondary DNS"}
        />
          ...
          <>
            {s.DHCP && (
              <>
                <div className="button-and-text-seperator"></div>
                <KeyValue
                  value={String(s.VPLNetwork?.Network)}
                  label={"VPL Network"}
                />
                <KeyValue
                  value={String(s.DHCP?.IP).replaceAll(",", ".")}
                  label={"IP"}
                />
            ...
            <KeyValue
              label={"Last Ping"}
              value={dayjs(s.PingTime).format("HH:mm:ss")}
            />
  ...
  return (
    <div className="connections">
      ...
      <div className="plus-button" onClick={() => addConnection()}>
        +
      </div>
    </div>
  );
