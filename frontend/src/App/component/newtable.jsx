											...
											>
												{r.items.map((i, index) => {
													...
													if (i.type === "text") {
														...
														if (["Connect", "Assign", "tunnels", "Active", "Inactive", "Error", "Warning", "Success"].includes(i.value)) {
															...
															cellContent = (
																<div className="relative group">
																	<span className={textColorClass}>{i.value}</span>
																	{i.tooltip === true && (
														...
														cellContent = <span className="text-white/80">{i.value}</span>;
													} else if (i.type === "img") {
														cellContent = (
															<div className="relative group">
																<img 
						...
						<div className="flex items-center gap-2">
							...
							>
								...
								<SelectContent className="bg-[#000000] border-[#222]">
									<SelectItem value="20" className="text-white/90 focus:bg-[#111]">20</SelectItem>
									<SelectItem value="50" className="text-white/90 focus:bg-[#111]">50</SelectItem>
									<SelectItem value="100" className="text-white/90 focus:bg-[#111]">100</SelectItem>
									<SelectItem value="200" className="text-white/90 focus:bg-[#111]">200</SelectItem>
									<SelectItem value="0" className="text-white/90 focus:bg-[#111]">All</SelectItem>
								</SelectContent>
							</Select>
							...
							>
								...
								<SelectContent className="bg-[#000000] border-[#222] max-h-[200px]">
									{arrayFromTotalPages(pg.TotalPages).map((i) => (
										<SelectItem key={i} value={String(i)} className="text-white/90 focus:bg-[#111]">
											{i + 1}
										</SelectItem>
									))}
								</SelectContent>
