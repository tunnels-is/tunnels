...
var palettes = map[string]palette{
	"tunnels-dark": {
		Base100: hex(0x0c, 0x0c, 0x0e), Base200: hex(0x04, 0x04, 0x05), Base300: hex(0x1c, 0x1c, 0x20),
		Elevate: hex(0x14, 0x14, 0x16), Divider: hex(0x16, 0x16, 0x18),
		Input:   hex(0x08, 0x08, 0x09),
		...
		Error: hex(0xe5, 0x48, 0x4d), ErrorHover: hex(0xf0, 0x5e, 0x62), ErrorSoft: rgba(0xe5, 0x48, 0x4d, 38),
		Warning: hex(0xd9, 0x8b, 0x0c), WarningSoft: rgba(0xf5, 0x9e, 0x0b, 38),
		Info: hex(0x38, 0xbd, 0xf8), InfoSoft: rgba(0x38, 0xbd, 0xf8, 38),
		Hover: hex(0x18, 0x18, 0x1c), Ring: rgba(0x4f, 0x8c, 0xff, 90), Shadow: rgba(0, 0, 0, 110), Dark: true,
	},
	"tunnels": {
		...
		Error: hex(0xd0, 0x27, 0x27), ErrorHover: hex(0xe0, 0x38, 0x38), ErrorSoft: rgba(0xd0, 0x27, 0x27, 26),
